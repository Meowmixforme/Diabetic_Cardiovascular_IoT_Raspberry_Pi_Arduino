...
@st.cache_resource
def init_mongodb():
    # MongoDB Atlas connection settings - Production database
    client = pymongo.MongoClient("mongodb+srv://mrnuts:v8255920@squirrel-red.uv3sje7.mongodb.net/?retryWrites=true&w=majority")
